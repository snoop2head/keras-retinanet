...
voc_classes = {"asian_giant_hornet": 0}
...
def _findNode(parent, name, debug_name=None, parse=None):
    ...
    if parse is not None:
        try:
            ...
            raise_from(
                ValueError("illegal value for '{}': {}".format(debug_name, e)), None
            )
    return result
...
class PascalVocGenerator(Generator):
    ...
    def __parse_annotations(self, xml_root):
        ...
        for i, element in enumerate(xml_root.iter("object")):
            try:
                ...
                raise_from(
                    ValueError("could not parse object #{}: {}".format(i, e)), None
                )
    ...
    def load_annotations(self, image_index):
        ...
        try:
            ...
            raise_from(
                ValueError("invalid annotations file: {}: {}".format(filename, e)), None
            )
        except ValueError as e:
            raise_from(
                ValueError("invalid annotations file: {}: {}".format(filename, e)), None
